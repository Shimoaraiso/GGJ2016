...
public class enemySpawn : MonoBehaviour {
    ...
    {
        Instantiate(enemy, new Vector3(PositionX, Random.Range(bottomPositon, topPositon), 0.0f), transform.rotation);//敵(enemy)生成
    }
    ...
    {
        Instantiate(enemy, new Vector3(Random.Range(leftPositon, rightPositon), PositionY), transform.rotation);//敵(enemy)生成
    }
}
